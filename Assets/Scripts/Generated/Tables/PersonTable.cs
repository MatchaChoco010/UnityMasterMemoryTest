...
namespace MasterData.Tables
{
   public sealed partial class PersonTable : TableBase<Person>
   {
        ...
        readonly Func<Person, (Gender Gender, int Age)> secondaryIndex1Selector;
        readonly Person[] secondaryIndex2;
        readonly Func<Person, Gender> secondaryIndex2Selector;
        ...
        public RangeView<Person> SortByGenderAndAge => new RangeView<Person>(secondaryIndex1, 0, secondaryIndex1.Length - 1, true);
        public RangeView<Person> SortByGender => new RangeView<Person>(secondaryIndex2, 0, secondaryIndex2.Length - 1, true);
